...
<?php $__env->startSection('content'); ?>
    <div class="w-full md:w-2/3 p-4">
        <div class="bg-white shadow-2xl rounded-xl p-8">
            ...
            <form method="POST" action="<?php echo e(route('report.proses')); ?>" enctype="multipart/form-data" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <select id="type" name="type" class="form-select">
                        ...
                        <option value="kejahatan" <?php echo e(old('type') == 'kejahatan' ? 'selected' : ''); ?>>Kejahatan</option>
                        <option value="pembangunan" <?php echo e(old('type') == 'pembangunan' ? 'selected' : ''); ?>>Pembangunan
                        </option>
                        <option value="sosial" <?php echo e(old('type') == 'sosial' ? 'selected' : ''); ?>>Sosial</option>
                    </select>
                </div>
...
<?php echo $__env->make('templates.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\Project\pengaduan-masyarakat\resources\views/pages/report/create.blade.php ENDPATH**/ ?>