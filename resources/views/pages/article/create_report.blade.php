    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="bg-white shadow-lg rounded-lg w-full max-w-xl p-6">
            ...
            <form method="POST" action="{{ route('report.proses') }}" enctype="multipart/form-data" class="space-y-4">
                ...
                <button type="submit" class="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                    Kirim
                </button>
            </form>
        </div>
